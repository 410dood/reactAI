...
class Register extends Component {
    ...
    onSubmitRegister = (e) => {
        ...
        e.preventDefault();
        fetch('https://heavydoodyai-rest.herokuapp.com/register', {
            method: 'post',
            headers: {
            ...
            if (resp.status !== 400) {
                Form
                    .setAlert
                    .call(this, resp.statusText, 'info');
            } else {
                Form
                    .setAlert
                    .call(this, resp.statusText, 'error');
            }
        }).catch(err => {
            this.setState({loading: false});
            Form
                .setAlert
                .call(this, 'Server not responding.', 'error');
        });;
    }
                    ...
                    <form onSubmit={this.onSubmitRegister} className="measure center">
                        ...
                        <div className="lh-copy">
                            <a
                                ...
                                className="f6 link dim black dib pointer">Sign In</a>
                        </div>
                    </form>
                </main>
            </article>
