...
//     ? <View style={styles.loader}> <ActivityIndicator size={75}
// color='#95a5a6'/>                   <Text style={styles.loaderText}>Analyse
// en cours...</Text> </View>    : <View style={styles.container}>
// <AnswerNotification answer={this.state.result}/>    <CaptureAndShare
// title='Partager' color='#3498db'                        image={sourceImage}
